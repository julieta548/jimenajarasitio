        ...
        <div id='about' className='about'>
            ...
            <div className='elementos-about'>
                <div className='presentacion'>
                    ...
                    <div className="fotos">
                        <img className='foto-about-1' src="img/mujer.svg" alt="mujer-sentada" />
                    </div>
                </div>
                <div className='presentacion-2'>
                    <div className="fotos">
                        <img className='foto-about-2' src="img/mujeres.svg" alt="" />
                    </div>
                    <p className='parrafo-presentacion'>
                        Hoy mi objetivo es crear piezas que no solo te vistan, sino que también te hagan sentir alguien hermoso y seguro.
